...
import { IoLocationSharp, IoLogoInstagram, IoLogoFacebook, IoLogoLinkedin, IoCall } from "react-icons/io5";
                ...
                <section className={styles.contactBar}>
                    ...
                    <div className={styles.rightContainer}>
                        <div className={styles.iconContainer}>
                            <IconContext.Provider value={{ size: 20, style: { paddingRight: 12 }, color: "#000000" }}>
