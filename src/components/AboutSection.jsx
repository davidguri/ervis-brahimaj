    ...
    <main className={styles.main}>
      <section className={styles.treatmentsSection}>
        <div className={styles.titleContainer}>
          ...
          <text className={styles.paragrapgh}>From lorem to ipsum, Dr. Ervis Brahimaj can help you with countless different issues, helping you live a healthier and happier lifestyle! If you can't find what you're looking for here, you can contact the doctor personaly by <span>Phone Number</span> or <span>Email</span>. We sincerely hope we could assist you!</text>
        </div>
