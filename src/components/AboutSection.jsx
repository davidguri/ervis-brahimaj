  ...
  return (
    <main className={styles.main}>
      <section className={styles.aboutSection}>
        <Fade top duration={1250} delay={250}>
      ...
      <section className={styles.treatmentsSection}>
        ...
        <Fade top>
          <div className={styles.titleContainer}>
            ...
            <text className={styles.paragraph}>
              From lorem to ipsum, Dr. Ervis Brahimaj can help you with
              countless different issues, helping you live a healthier and
              happier lifestyle! If you can't find what you're looking for here,
              you can contact the doctor personaly by
              <span className={styles.socials}> Phone Number</span> or
              <span className={styles.socials}> Email</span>. We sincerely hope
              we could assist you!
            </text>
          </div>
        </Fade>
